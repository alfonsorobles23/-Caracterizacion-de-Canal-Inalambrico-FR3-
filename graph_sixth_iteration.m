...
hold on;
% --- OPTIMIZATIONS FOR PUBLICATION (MODIFIED VALUES) ---
...
title('Path Loss vs. Distance: CI Model vs. Measurements', 'FontSize', poster_font_size * 1.2, 'FontWeight', 'bold');
xlabel('Manhattan Distance [m]', 'FontSize', poster_font_size);
ylabel('Path Loss [dB]', 'FontSize', poster_font_size);
...
fprintf('Process finished. The plot has been optimized for publication.\n');